...
Normative rules for the first production SVG phase:
- The lid remains a dedicated panel in the flat layout.
- The lid contour must remain a closed path.
- The lid must not contain annotations in production output.